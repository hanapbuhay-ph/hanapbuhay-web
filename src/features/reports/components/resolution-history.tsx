...
interface ResolutionHistoryProps {
  history: ReportHistoryEntry[] | undefined
}

export function ResolutionHistory({ history }: ResolutionHistoryProps) {
              ...
              <li key={entry.id} className='flex gap-3'>
                ...
                <div className='pb-5'>
                  <div className='flex flex-wrap items-center gap-2'>
                    ...
                    {/* Status pill */}
                    <ReportStatusBadge status={entry.status as ReportStatus} />
                  </div>
